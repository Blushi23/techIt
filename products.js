...
function showProducts() {
    for (let i = 0; i < products.length; i++) {
        document.getElementById("products").innerHTML += `<div class="col-md-4">
...
function setModal(index) {
    ...
    document.getElementById("modalText").innerHTML = `<p><b>Serial number:</b> ${products[index].id}</p><p><b>Category:</b> ${products[index].category}</p><p><b>Description:</b> ${products[index].description}</p><br><h4 class="text-end">Price: ${products[index].price}</h4> `
}